...
use GEA\SoporteBundle\Model\map\PerfilTableMap;
...
abstract class BasePerfilPeer
{
    ...
    const OM_CLASS = 'GEA\\SoporteBundle\\Model\\Perfil';

    /** the related TableMap class for this table */
    const TM_CLASS = 'GEA\\SoporteBundle\\Model\\map\\PerfilTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePerfilPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \GEA\SoporteBundle\Model\map\PerfilTableMap());
      }
    }
