...
use GEA\SoporteBundle\Model\map\MenuTableMap;
...
abstract class BaseMenuPeer
{
    ...
    const OM_CLASS = 'GEA\\SoporteBundle\\Model\\Menu';

    /** the related TableMap class for this table */
    const TM_CLASS = 'GEA\\SoporteBundle\\Model\\map\\MenuTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseMenuPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \GEA\SoporteBundle\Model\map\MenuTableMap());
      }
    }
