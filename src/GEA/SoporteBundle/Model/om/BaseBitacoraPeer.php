...
use GEA\SoporteBundle\Model\map\BitacoraTableMap;
...
abstract class BaseBitacoraPeer
{
    ...
    const OM_CLASS = 'GEA\\SoporteBundle\\Model\\Bitacora';

    /** the related TableMap class for this table */
    const TM_CLASS = 'GEA\\SoporteBundle\\Model\\map\\BitacoraTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBitacoraPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \GEA\SoporteBundle\Model\map\BitacoraTableMap());
      }
    }
