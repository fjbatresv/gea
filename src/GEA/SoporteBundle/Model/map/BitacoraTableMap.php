...
class BitacoraTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.GEA.SoporteBundle.Model.map.BitacoraTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('GEA\\SoporteBundle\\Model\\Bitacora');
    ...
    {
        $this->addRelation('Usuario', 'GEA\\SoporteBundle\\Model\\Usuario', RelationMap::MANY_TO_ONE, array('usuario_id' => 'id', ), null, null);
    } // buildRelations()
