...
class PerfilMenuTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.GEA.SoporteBundle.Model.map.PerfilMenuTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('GEA\\SoporteBundle\\Model\\PerfilMenu');
    ...
    {
        $this->addRelation('Perfil', 'GEA\\SoporteBundle\\Model\\Perfil', RelationMap::MANY_TO_ONE, array('perfil_id' => 'id', ), 'CASCADE', null);
        $this->addRelation('Menu', 'GEA\\SoporteBundle\\Model\\Menu', RelationMap::MANY_TO_ONE, array('menu_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
